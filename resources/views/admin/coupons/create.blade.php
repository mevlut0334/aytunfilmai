...
@section('title', 'Yeni Kupon Ekle - Admin Panel')
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0"><i class="bi bi-ticket-perforated"></i> Kupon Oluştur</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.coupons.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Boş bırakılırsa sınırsız kullanım.</small>
                            @error('max_usage')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
