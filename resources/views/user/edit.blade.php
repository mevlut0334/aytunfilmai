...
<head>
    ...
    <title>Profili Düzenle - Aytun Film AI</title>
                ...
                <div class="col-md-8 col-lg-7">
                    <div class="edit-card">
                        <div class="edit-header">
                            <h4><i class="bi bi-pencil"></i> Profili Düzenle</h4>
                        </div>
                        <div class="edit-body">
                            <form action="{{ route('user.update') }}" method="POST">
                                ...
                                <h5 class="section-title">Şifre Değiştir (Opsiyonel)</h5>
                                <p class="section-note">Şifrenizi değiştirmek istemiyorsanız bu alanları boş bırakabilirsiniz.</p>
